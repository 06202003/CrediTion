    ...
    12: function (t, e, i) {
      ...
      class r extends s.b {
        ...
        onUpdate() {
          ...
          const e = this.camera;
          Math.abs(e.tx - e.position.x) > 0.01 && ((t = e.tx - e.position.x), (e.position.x += 0.02 * t)), Math.abs(e.ty - e.position.y) > 0.01 && ((t = e.ty - e.position.y), (e.position.y += 0.02 * t)), e.lookAt(new n.Vector3(0, 0, 0));
          let i = 0,
            s = 0,
            o = 0;
