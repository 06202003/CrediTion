...
function a() {
  ...
  var w = document.querySelectorAll('.container1');
  if (x.style.backgroundColor == 'black') {
    document.body.style.backgroundColor = 'white';
    document.getElementById('container1').style.backgroundImage = "url('../src/WM1.jpg')";
    ...
    document.getElementById('filling').style.fill = '#133764';
    ...
    document.getElementById('container1').style.backgroundImage = "url('../src/WM.jpg')";
    ...
    document.getElementById('filling').style.fill = '#25292e';
